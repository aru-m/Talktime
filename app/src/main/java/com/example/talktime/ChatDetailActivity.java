...
import com.example.talktime.Adapters.ChatAdapter;
import com.example.talktime.Models.Message;
import com.example.talktime.databinding.ActivityChatDetailBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot i: snapshot.getChildren()){
                            Message model = i.getValue(Message.class);
                            messages.add(model);
                        }
        ...
        binding.sendbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Message messagesModel = new Message(senderID,message);
